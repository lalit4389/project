...
import { Mail, Phone, Lock, TrendingUp } from 'lucide-react';
...
interface ForgotForm {
  email?: string;
  // phone?: string; // Removed phone field as per user request
  otp?: string;
  password?: string;
                ...
                <div className="mt-4 text-center">
                  {canResendOtp ? (
                    <button
                      ...
                      disabled={isLoading}
                      className="text-olive-400 hover:text-olive-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    >
